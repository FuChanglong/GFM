...
def load_data(dataset, seed=0):
    if dataset == 'cora':
        ...
        c_descs = [
            " characterized by preclinical and laboratory-based diabetes research, emphasizing animal models, cell experiments, molecular mechanisms, and therapeutic validation under controlled settings.",
            " defined by autoimmune destruction of pancreatic beta cells, absolute insulin deficiency, insulin dependence, and immune-mediated onset, centering on the pathogenesis and management of Type 1 diabetes.",
            " marked by insulin resistance, metabolic dysfunction, progressive beta-cell impairment, and strong links to obesity and lifestyle factors, focusing on the mechanisms and treatment of Type 2 diabetes."
        ]
        # c_descs = [
        #     " centered on laboratory evidence, animal models, cell assays, and mechanistic investigation of glucose-related disorders in controlled experimental settings.",
        #
        #     " characterized by autoimmune beta-cell destruction, juvenile onset, absolute insulin loss, and lifelong insulin dependence.",
        #
        #     " characterized by obesity-associated insulin resistance, metabolic syndrome, gradual beta-cell failure, and adult-onset dysregulation of blood glucose."
        # ]
